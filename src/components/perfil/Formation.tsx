        ...
        <section className="flex items-center justify-between gap-[2rem] w-full">
            <div>
                ...
                <div className="w-[50%] flex gap-[2rem]">
                    <IconTech icon={BiLogoJavascript} percentage="100%"/>
                    <IconTech icon={BiLogoReact} percentage="100%"/>
                    <IconTech icon={TbDatabaseSearch} percentage="100%"/>
                    <IconTech icon={BiLogoPython} percentage="100%"/>
                    <IconTech icon={BiLogoNodejs} percentage="100%"/>
                </div>
            </div>
        </section>
    )
