    ...
    return (
        <section className="flex justify-between gap-[2rem] w-full mt-[2rem]">
            <div className="w-[100%] phone:flex fphone: flex-col phone: items-center">
                ...
                <p className="w-[50%] text-gray-400 mt-[1.5rem] phone:w-[100%]  phone:text-center">Cursando Análise e desenvolvimento de sistemas na <strong>universidade Unopar</strong></p>
