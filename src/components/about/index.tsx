    ...
    return (
        <>
            ...
            <div className="max-w-[800px] flex flex-col items-center">
                <p className="leading-[1.8]">Olá, meu nome é César e sou um desenvolvedor Full-Stack apaixonado por criar soluções tecnológicas inovadoras. Tenho vasta experiência trabalhando em equipe, onde valorizo a colaboração e o compartilhamento de conhecimento para alcançar resultados excepcionais.
                <br />
                <br />
